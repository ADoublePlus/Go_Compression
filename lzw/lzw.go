...
import (
	...
	"github.com/ADoublePlus/Go_Compression/logging"
)

/*
	TODO:
		- Profile memory allocations.
		- Code duplication in the flush part of Compress()
		- Use variants instead of uint16
 */

func Compress(rawData io.Reader) (compressData *[]byte, nbits int) {
	var out []byte
...
func Uncompress(compressData io.Reader, nbits int) (uncompressData *[]byte) {
	var out []byte
	...
	for {
		n, err := compressData.Read(readBuffer)
